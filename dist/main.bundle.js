...
const uiController = (function () {
  ...
  const createTodoItem = () => {
    ...
    const enteredDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(todoDueDate), "dd-MM-yyyy");
    const todoPriority = document.getElementById("todoPriority").value;

    return (0,_todo__WEBPACK_IMPORTED_MODULE_0__.createTodo)(todoTitle, todoNotes, todoPriority, false, enteredDate);
  };
